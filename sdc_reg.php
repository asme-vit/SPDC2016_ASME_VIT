...
<div class="container">
  <div class="jumbotron">
    <h1>Student Design Competition 2016</h1>
...
<div class="container">
    <div class="row">
        <form role="form" action="sdc_reg_php.php" method="post">
		<div class="col-lg-3"></div>
            <div class="col-lg-6">
				...
				<div class="form-group">
                    <label for="InputName">Name of the SDC Team:</label>
                    <div class="input-group">
                        <input type="text" class="form-control" name="teamnm" id="InputName" placeholder="Enter Team Name" required>
                ...
                <div class="form-group">
                    <label for="InputName">Number of Team Members:</label>
                    <div class="input-group">
                        <input type="number" min="1" step="1" class="form-control" name="number" id="InputName" placeholder="Number of Team Members" required>
                        <span class="input-group-addon" style="color:red;"><span class="glyphicon glyphicon-asterisk"></span></span>
                    </div>
                </div>
				<div class="form-group">
