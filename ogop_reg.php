...
<div class="container">
  <div class="jumbotron">
    <h1>The Old Guard Oral Presentation Competition</h1>
    <p>An engineer, like all professionals, must possess a well-developed ability to communicate, both orally and in writing. This competition is designed to emphasize the value of an ability to deliver oral presentations.</p> 
  </div>
</div>
<!-- Registration form - START -->
<div class="container">
    <div class="row">
        <form role="form" action="ogop_reg_php.php" method="post">
