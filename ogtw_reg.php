...
<div class="container">
  <div class="jumbotron">
    ...
    <p>This web page design competition is intended to encourage the delivery of visual presentations using web page technology.</p> 
  </div>
</div>
<!-- Registration form - START -->
<div class="container">
    <div class="row">
        <form role="form" action="ogtw_reg_php.php" method="post">
